...
const DetailGenreForm = forwardRef<HTMLFormElement, IProps>(
  (
    { detail, closeModal, addChanges, changes = [], onEdit, resetChanges },
    ref
  ) => {
    ...
    const defaultValues = normalizeDefaultValues(resignDetail);
...
DetailGenreForm.displayName = 'DetailGenreForm';
